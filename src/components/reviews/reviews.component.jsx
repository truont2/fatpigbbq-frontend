    ...
    return (
      <div className="max-w-[1400px] mx-auto pb-16 px-4">
        ...
        {data.map((review, key) => {
          return (
            <div key={key}>
              <div className="text-center max-h-[80vh] py-5 px-4 w-4/6 mx-auto flex flex-col items-center justify-center text-gray-500">
                ...
                <a className="pt-6 underline" href="https://www.yelp.com/biz/fat-pig-bbq-edmonds">
                  Yelp
                </a>
              </div>
            </div>
